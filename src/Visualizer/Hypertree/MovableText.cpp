...
MovableText::MovableText(const String &name, const String &caption, const Ogre::String &iMaterialName, const String &fontName, Real charHeight, const ColourValue &color)
: mpCam(NULL)
, mpWin(NULL)
, mpFont(NULL)
, mName(name)
...
, mForceVisible( false )
{
    ...
    this->setFontName(mFontName,iMaterialName);
    this->_setupGeometry();
}
...
void MovableText::setFontName(const String &fontName, const String &iMaterialName)
{
    ...
    if (mFontName != fontName || mpMaterial.isNull() || !mpFont)
    {
        ...
        mpMaterial = ((MaterialPtr)(MaterialManager::getSingleton().getByName( iMaterialName, ResourceGroupManager::AUTODETECT_RESOURCE_GROUP_NAME )))->clone(mName + "Material");
...
void MovableText::_setupGeometry()
{
    ...
    {
        mRadius = 200;
        mAABB = Ogre::AxisAlignedBox( Ogre::Vector3( -100, -100, -100 ), Ogre::Vector3( 100, 100, 100 ) );
    }
