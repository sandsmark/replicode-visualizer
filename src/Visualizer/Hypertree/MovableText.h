...
namespace Ogre {
    ...
    protected:
        ...
        /******************************** public methods ******************************/
    public:
        MovableText(const String &name, const String &caption, const Ogre::String &iMaterialName, const String &fontName = "BlueHighway", Real charHeight = 1.0, const ColourValue &color = ColourValue::White );
        virtual ~MovableText();
        ...
        // Set settings
        void    setFontName(const String &fontName,const String &iMaterialName);
        ...
        void ForceVisible( bool iForce )
        {
            mForceVisible = iForce;
            if ( mForceVisible )
            {
                mRadius = 200;
